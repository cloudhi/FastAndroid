...
public class ChangeValueView extends DividerLayout{
    ...
    public ChangeValueView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if(inputMax != -1){
            ...
            mValue.setFilters(new InputFilter[]{filter});
        }
        myAttrs.recycle();
        bindActions();
    }
    ...
    private void bindActions(){
        final ImageView mIncrease = ViewFinder.find(R.id.ios_increase, this);
        final ImageView mReduces = ViewFinder.find(R.id.ios_reduce, this);

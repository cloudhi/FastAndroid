...
/**
 * 原生的FragmentTabHost在切换Fragment时，会将Fragment Attache和Detach。
 * 这里改为用Show、Hide来切换Fragment。
...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
     ...
     * call {@link #setup(android.content.Context, FragmentManager)} or
     * {@link #setup(android.content.Context, FragmentManager, int)}.
     */
    @Override @Deprecated
    public void setup() {
